...
def find_nearest(df1, df2, target_landmark, distance_to_target_landmark):
    """
    ...
    for building_name in building_names:
        try:
            prop_loc = (float(df1.loc[df1['building_name'] == building_name, 'latitude'].unique()[0]),
        ...
        for idx, eachloc in enumerate(df2.iloc[:, 0]):
            ...
            distance = haversine(prop_loc, landmark_loc)
