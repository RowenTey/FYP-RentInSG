...
PROPERTY_TYPES = [
    'Condo', 'Apartment', 'HDB', 'Conservation House', 'Bungalow',
    'Terraced House', 'HDB Executive', 'Shophouse', 'Corner Terrace',
    'Cluster House', 'Semi-Detached House', 'Executive Condo', 'Landed',
    'Townhouse', 'Walk-up', 'Executive HDB'
]

FURNISHING = ['Partial', 'Fully', 'Unfurnished', 'Flexible']

FACING = ['South', 'North', 'South East', 'South West', 'North East', 'West', 'East',
